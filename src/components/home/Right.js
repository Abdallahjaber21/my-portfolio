  ...
  return (
    <div className="right_scrollable_section">
      ...
      <section id="experience" className="mt-20">
            <ExperienceCard from="2018" to="present" title="Lead Engineer . Codendot" position="Senior Engineer Eng" position_details="Deliver high-quality, robust production code for a diverse array of projects for clients including Harvard Business School, Everytown for Gun Safety, Pratt Institute, Koala Health, Vanderbilt University, The 19th News, and more. Provide leadership within engineering department through close collaboration, knowledge shares, and mentorship." position_skills="yii2,framwork7,reactjs"/>
